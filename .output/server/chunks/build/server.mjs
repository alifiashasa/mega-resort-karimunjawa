import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { getCurrentInstance, hasInjectionContext, inject, computed, getCurrentScope, shallowRef, toRef, isRef, defineComponent, createElementBlock, provide, cloneVNode, h, defineAsyncComponent, unref, shallowReactive, ref, useSSRContext, createApp, createVNode, Text, Fragment, isVNode as isVNode$1, createCommentVNode, withCtx, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, reactive, effectScope, Suspense, nextTick, mergeProps, isReadonly, toRaw, isShallow, isReactive } from 'vue';
import { l as createError$1, q as sanitizeStatusCode, r as getContext, $ as $fetch, v as baseURL, w as defu, x as createHooks, y as executeAsync, z as getRequestProtocol, A as klona, B as getRequestHeaders, C as parse$1, D as getRequestHeader, d as destr, E as setCookie, F as getCookie, G as deleteCookie } from '../_/nitro.mjs';
import { createPinia, setActivePinia, shouldHydrate } from 'pinia';
import { useRoute as useRoute$1, RouterView, isNavigationFailure, START_LOCATION, createMemoryHistory, createRouter } from 'vue-router';
...
const _routes = [
  {
    name: "index___en",
    path: "/",
    component: () => import('./index-g9bDoi2i.mjs')
  },
  {
    name: "index___id",
    path: "/id",
  ...
  },
  {
    name: "rooms___en",
    path: "/rooms",
    component: () => import('./rooms-DWgZja2T.mjs')
  },
  {
    name: "rooms___id",
    path: "/id/rooms",
  ...
  en: [
    {
      ...
      load: () => import(
        './en-B7CKLVs1.mjs'
        /* webpackChunkName: "locale_en_46json_69b9988f" */
      ),
      cache: true
    }
  ],
  id: [
    {
      ...
      load: () => import(
        './id-wwUR09Bp.mjs'
        /* webpackChunkName: "locale_id_46json_c1537a5f" */
      ),
      cache: true
    }
  ]
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-BCg1CoS9.mjs').then((m) => m.default || m))
};
  ...
  setup(__props) {
    ...
    useHead({
      ...
      titleTemplate: (titleChunk) => {
        return titleChunk ? `${titleChunk} | Mega Resort Karimunjawa` : "Mega Resort Karimunjawa - Luxury Island Getaway";
      },
      link: [
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BEvrdHzO.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-Bb-YyqUO.mjs'));
...
export { useI18n as a, useSeoMeta as b, useNuxtApp as c, asyncDataDefaults as d, entry_default as default, createError as e, useLocalePath as f, useRoute as g, useRouter as h, encodeRoutePath as i, hasProtocol as j, joinURL as k, isScriptProtocol as l, useRuntimeConfig as m, navigateTo as n, withoutTrailingSlash as o, parseQuery as p, nuxtLinkDefaults as q, resolveRouteObject$1 as r, useHead as u, withTrailingSlash as w };
